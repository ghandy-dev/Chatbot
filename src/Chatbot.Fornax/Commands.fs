...
let commands =
    [
        ...
        CommandInfo.create "calculator" [ "calc" ; "math" ] HelpInfo.Calculator 50 false true
        ...
        CommandInfo.create "echo" [] HelpInfo.Echo 50 true true
        CommandInfo.create "encode" [] HelpInfo.Encode 50 false true
        ...
        CommandInfo.create "joinchannel" [] HelpInfo.JoinChannel 50 true false
        CommandInfo.create "lastline" [ "ll" ] HelpInfo.LastLine 50 false true
        CommandInfo.create "leavechannel" [] HelpInfo.LeaveChannel 50 true false
        ...
        CommandInfo.create "ping" [] HelpInfo.Ping 50 false true
        CommandInfo.create "randomclip" [ "rc" ] HelpInfo.RandomClip 20 false true
        CommandInfo.create "randomemote" [] HelpInfo.RandomEmote 50 false true
        ...
        CommandInfo.create "refreshchannelemotes" [ "rce" ] HelpInfo.RefreshChannelEmotes 50 true false
        CommandInfo.create "refreshglobalemotes" [ "rge" ] HelpInfo.RefreshGlobalEmotes 50 true false
        CommandInfo.create "remind" [ "notify" ] HelpInfo.Remind 50 false true
        ...
        CommandInfo.create "time" [] HelpInfo.Time 50 false true
        CommandInfo.create "texttoascii" [ "tta" ] HelpInfo.TextToAscii 15 false true
        CommandInfo.create "texttransform" [ "tt" ] HelpInfo.TextTransform 50 false true
