...
module Commands =
    ...
    let commandsList =
        [
            ...
            Command.createCommand ("randomemote", [], HelpInfo.RandomEmote, SyncFunctionWithArgsAndContext randomEmote, 5000, false)
            ...
            Command.createCommand ("refreshchannelemotes", [ "rce" ], HelpInfo.RefreshChannelEmotes, SyncFunctionWithArgsAndContext refreshChannelEmotes, 5000, true)
            Command.createCommand ("refreshglobalemotes", [ "rge" ], HelpInfo.RefreshGlobalEmotes, SyncFunctionWithArgs refreshGlobalEmotes, 5000, true)
